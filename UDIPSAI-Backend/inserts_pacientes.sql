...
BEGIN
    ...
    SELECT id INTO v_sede_id FROM sedes WHERE nombre = 'Sede Cuenca' LIMIT 1;
    ...
    -- Insertar paciente 1
    IF NOT EXISTS (SELECT 1 FROM pacientes WHERE cedula = '1001001001') THEN
        INSERT INTO pacientes (
            ...
            '1001001001', 'Juan Pérez', 'Cuenca', '2015-05-10', 'Av. Loja y Don Bosco',
