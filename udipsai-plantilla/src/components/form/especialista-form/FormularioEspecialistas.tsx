    ...
    try {
      ...
      const payload = {
        ...
        permisos: {
          ...
          pasantes: permisos.pasantes,
          sedes: permisos.sedes,
          especialistas: permisos.especialistas,
          especialidades: permisos.especialidades,
          asignaciones: permisos.asignaciones,
          recursos: permisos.recursos,
          institucionesEducativas: permisos.institucionesEducativas,
          historiaClinica: permisos.historiaClinica,
          fonoAudiologia: permisos.fonoAudiologia,
          psicologiaClinica: permisos.psicologiaClinica,
          psicologiaEducativa: permisos.psicologiaEducativa,
        },
      };
      if (isEditing) {
